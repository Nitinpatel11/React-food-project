...
import foodCategoryImg04 from "../assets/images/foodCategoryImg04.png";
...
const featureData = [
  {
    ...
    imgUrl: featureImg01,
    desc: "Experience lightning-fast delivery with Fresh Bites, ensuring your meal arrives swiftly to your doorstep.",
  },

  {
    title: "Super Dine In",
    imgUrl: featureImg02,
    desc: "Experience the ultimate dining convenience with Super Dine In, where delicious meals are just a click away.",
  },
  {
    title: "Easy Pick Up",
    imgUrl: featureImg03,
    desc: "Enjoy the convenience of easy pick-up options, making your Fresh Bites experience even more seamless.",
  },
];
    ...
    <Helmet title="Home">
      ...
      <section className="why__choose-us">
        <Container>
          <Row>
            <Col lg="6" md="6">
              <img src={whyImg} alt="why-fresh-bites" className="w-100" />
            </Col>

            <Col lg="6" md="6">
              <div className="why__fresh-bites">
                <h2 className="fresh-bites-title mb-4">
                  Why <span>Fresh Bites?</span>
                </h2>
                <p className="fresh__bites-desc">
      ...
      <section className="pt-0 food-pop">
        <Container>
          <Row>
